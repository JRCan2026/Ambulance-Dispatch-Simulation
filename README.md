...
2) Optimized policy (OP): assigns ambulances by solving a global allocation problem at each timestep, aiming to minimize total travel time across assignments in the system.
